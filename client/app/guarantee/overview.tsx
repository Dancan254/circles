  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <AppBanner />
        <Text style={styles.title}>Guarantee Overview</Text>
        <Text style={styles.subtitle}>
          You've successfully guaranteed a loan for Sylus Abel. He will be
          notified shortly.
        </Text>
      </View>
      <View style={styles.animationContainer}>
        ...
        <TouchableOpacity style={styles.shareButton}>
          <Text style={styles.footerText}>Share with Loan Applicant</Text>
